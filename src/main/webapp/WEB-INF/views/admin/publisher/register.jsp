...
<main class="main-content">
    ...
    <h3 class="section-title">📝 새 출판사 등록</h3>
    
    <!-- 기존에 만드신 form 전송 로직 100% 그대로 유지 -->
    <form action="/backoffice/admin/publisher/register" method="post" style="background:#1a1a1a; padding:30px; border-radius:12px; border:1px solid #333; max-width:600px;">
        
        <div class="form-group">
            <label>출판사명</label>
            <input type="text" name="name" required placeholder="출판사 이름을 입력하세요">
        </div>
        
        <div class="form-group">
            <label>연락처</label>
            <input type="text" name="contact" required placeholder="예) 02-1234-5678">
        </div>
