...
<main class="main-content">
    ...
    <h3 class="section-title">📝 새 카테고리 등록</h3>
    
    <!-- 기존에 만드신 form 전송 로직 100% 그대로 유지 -->
    <form action="/backoffice/admin/category/register" method="post" style="background:#1a1a1a; padding:30px; border-radius:12px; border:1px solid #333; max-width:600px;">
        
        <div class="form-group">
            <label>상위 카테고리 (선택)</label>
            <select name="parent_id">
                <option value="0">--- 없음 (대분류로 등록) ---</option>
        ...
        <div class="form-group">
            <label>카테고리명</label>
            <input type="text" name="name" required placeholder="카테고리명을 입력하세요">
        </div>
