...
<style>
    ...
    input[type="text"]:focus, textarea:focus { border-color: #deff9a; outline: none; }
...
<main class="main-content">
    ...
    <h3 class="section-title">📝 새 저자 등록</h3>
    
    <!-- 기존에 만드신 form 전송 로직 100% 그대로 유지 -->
    <form action="/backoffice/admin/author/register" method="post" style="background:#1a1a1a; padding:30px; border-radius:12px; border:1px solid #333; max-width:600px;">
        
        <div class="form-group">
            <label>저자명</label>
            <input type="text" name="name" required placeholder="저자 이름을 입력하세요">
        </div>
        
        <div class="form-group">
            <label>소개글 (선택)</label>
            <textarea name="bio" placeholder="저자에 대한 간단한 소개를 입력하세요"></textarea>
        </div>
        
        <div class="form-group" style="margin-bottom:0; margin-top:30px;">
            <button type="submit" class="btn-submit">등록 완료</button>
            <a href="/backoffice/admin/author/list" class="btn-cancel">취소</a>
        </div>
