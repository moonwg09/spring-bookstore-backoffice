...
<main class="main-content">
    ...
    <h3 class="section-title">🛠️ 저자 정보 수정</h3>
    
    <!-- 기존에 만드신 form 수정 로직 100% 그대로 유지 -->
    <form action="/backoffice/admin/author/modify" method="post" style="background:#1a1a1a; padding:30px; border-radius:12px; border:1px solid #333; max-width:600px;">
